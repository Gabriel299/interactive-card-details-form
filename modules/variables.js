...
export let nrCard = document.querySelectorAll(".nr-card span")
export let expireMonth = document.querySelector(".expire span:first-child")
export let expireYear = document.querySelector(".expire span:last-child")
export let cvv = document.querySelector(".back-card span")

// SECTION
export let section = document.querySelector("section")

// FORM
export let form = document.querySelector("form")
export let inputName = document.querySelector("#cardholder-name")
export let errorCardholderName = document.querySelector(".cardholder-name-error")
